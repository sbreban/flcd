...
public class Grammar {
  ...
  public Grammar() {
    ...
    this.productionsString = new ArrayList<>();
  }
  ...
  public void addProduction(String left, String right) {
    ...
    rightList.add(right);
    productionsString.add(left+"->"+right);
  }

  public List<String> getProductionsForSymbol(String symbol) {
  ...
  public List<String> getProductionsString() {
